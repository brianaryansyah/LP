...
const drinks = [
  { name: "Es Teh Manis", price: "Rp 4.000", desc: "Teh diseduh pekat, disajikan dingin. Teman wajib mie ayam.", pair: "Pasangan Mie Ayam Original" },
  { name: "Teh Hangat", price: "Rp 3.000", desc: "Untuk yang tidak suka dingin. Manisnya bisa request.", pair: "Pasangan Bakso Kuah" },
  { name: "Es Jeruk", price: "Rp 5.000", desc: "Jeruk peras asli, segar penawar pedas sambal.", pair: "Pasangan Hotplate Seafood" },
  { name: "Jeruk Hangat", price: "Rp 4.000", desc: "Hangat dan segar, cocok untuk tenggorokan.", pair: "Pasangan Mie Ayam Bakso" },
  { name: "Air Mineral", price: "Rp 3.000", desc: "Air mineral dingin kemasan botol.", pair: "Untuk anak-anak" },
];
            ...
            {drinks.map((d) => (
              ...
              >
                <div>
                  ...
                  <span className="mt-1.5 inline-block rounded-full bg-[#f5b041]/10 px-3 py-0.5 text-[11px] font-bold text-[#e09132]">
                    {d.pair}
                  </span>
                </div>
